...
namespace CMCS.DumblyConcealer.Tasks.AutoCupboard_NCGM
{
    ...
    public class EquAutoCupboard_NCGM_DAO
    {
        ...
        public int SynCYGPut(Action<string, eOutputType> output)
        {
            ...
            IList<InfCYGSam> cygSam = commonDAO.SelfDber.Entities<InfCYGSam>("where IsNew=1 and UpdateTime<:UpdateTime order by UpdateTime", new { UpdateTime = DateTime.Now.AddDays(-day + 1) });
