...
namespace CMCS.Common.Entities.Fuel
{
    ...
    public class Fultbtransfer : EntityBase1
    {
        ...
        /// 调运类别
        /// </summary>
        public virtual string TRANSFERTYPE { get { return _TRANSFERTYPE; } set { _TRANSFERTYPE = value; } }
        ...
        /// 车数
        /// </summary>
        public virtual Decimal TRANSFERNUMBER { get { return _TRANSFERNUMBER; } set { _TRANSFERNUMBER = value; } }
