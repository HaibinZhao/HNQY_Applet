...
namespace CMCS.Common
{
	...
	public static class GlobalVars
	{
		...
		/// 设备编码 - 皮带采样机 #1
		/// </summary>
		public static string MachineCode_PDCYJ_1 = "#1入厂皮带采样机";

		/// <summary>
		/// 设备编码 - 皮带采样机 #2
		/// </summary>
		public static string MachineCode_PDCYJ_2 = "#2入厂皮带采样机";

		/// <summary>
		/// 接口类型 - 徐州赛摩皮带采样机
		/// </summary>
		public static string InterfaceType_PDCYJ = "长沙万通火车皮带采样机";
