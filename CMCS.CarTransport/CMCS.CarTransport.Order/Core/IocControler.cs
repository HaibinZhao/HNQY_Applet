...
namespace CMCS.CarTransport.Order.Core
{
    /// <summary>
    /// IO控制器设备控制
    /// </summary>
    public class IocControler
    {
        ...
        public void Gate3Up()
        {
            ...
            commonDAO.SetSignalDataValue(CommonAppConfig.GetInstance().AppIdentifier, "道闸3升杆", "3");
        }
        /// <summary>
        /// 道闸3降杆
        /// </summary>
        ...
        public void Gate4Up()
        {
            ...
            commonDAO.SetSignalDataValue(CommonAppConfig.GetInstance().AppIdentifier, "道闸4升杆", "4");
        }
