...
namespace CMCS.CarTransport.JxSampler.Core
{
    ...
    public class IocControler
    {
        ...
        public void RedLight2()
        {
            ...
            commonDAO.SetSignalDataValue(CommonAppConfig.GetInstance().AppIdentifier, eSignalDataName.信号灯2.ToString(), "1");
        }
        ...
        public void GreenLight2()
        {
            ...
            commonDAO.SetSignalDataValue(CommonAppConfig.GetInstance().AppIdentifier, eSignalDataName.信号灯2.ToString(), "0");
        }
    }
}
